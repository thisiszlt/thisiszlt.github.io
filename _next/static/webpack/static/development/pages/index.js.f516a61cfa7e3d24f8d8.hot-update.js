      ...
      Dynamsoft.BarcodeScanner.createInstance({
        ...
        if (scanner._isOpen === false) {
          ...
          scanner.open().then(function (paras) {
            scanner.setResolution(_this4.state.resolution);
            var settings = scanner.getRuntimeSettings();
            settings.barcodeFormatIds = _this4.state.barcodeFormat;
            settings.localizationModes = _this4.state.localization;
            settings.deblurLevel = _this4.state.deblurLevel; // console.log(settings);
            ...
            scanner.updateRuntimeSettings(settings).then(function () {
              ...
              scanner.getAllCameras().then(function (cameras) {
                ...
                scanner.setCurrentCamera(cameras[_this4.state.camera].deviceId);
              });
            });
          });
          /*.then((r)=>{
...
//# sourceMappingURL=index.js.f516a61cfa7e3d24f8d8.hot-update.js.map