...
/* harmony import */ var react_addons_css_transition_group__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-addons-css-transition-group */ "./node_modules/react-addons-css-transition-group/index.js");
/* harmony import */ var react_addons_css_transition_group__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(react_addons_css_transition_group__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _static_css_Layout_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../static/css/Layout.css */ "./static/css/Layout.css");
/* harmony import */ var _static_css_Layout_css__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_static_css_Layout_css__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _SettingPage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SettingPage */ "./pages/components/SettingPage.js");
...
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(EachResult, _React$Component);

  function EachResult() {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, EachResult);

    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(EachResult).apply(this, arguments));
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(EachResult, [{
    key: "copyScannerResult",
    value: function copyScannerResult() {
      var kUtil = window.kUtil;
      kUtil.copyToClipBoard(this.props.content);
      var config = {};
      config.content = "copy successfully!";
      config.icon = __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Icon"], {
        type: "smile",
        style: {
          color: "#FE8E14"
        }
      });
      antd__WEBPACK_IMPORTED_MODULE_7__["message"].config({
        top: window.innerHeight - 180,
        duration: 1.5
      });
      antd__WEBPACK_IMPORTED_MODULE_7__["message"].open(config);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return __jsx("div", {
      ...
      }, __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx("span", {
        style: {
          color: "#FE8E14"
        }
        ...
        onClick: this.copyScannerResult.bind(this)
      }, this.props.content), __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx("span", {
        style: {
          color: "#FE8E14"
        }
      }, " x ", this.props.count))));
...
function (_React$Component2) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Result, _React$Component2);
    ...
    value: function render() {
      var resultItems = this.props.resultsInfo.slice(-3).map(function (ri, index) {
        return __jsx(EachResult, {
          key: index,
          content: ri.result.BarcodeText,
          count: ri.count,
          format: ri.result.BarcodeFormatString
        });
      });
      return __jsx("div", {
...
function (_React$Component3) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Canvas, _React$Component3);
  ...
  function Canvas(props) {
    ...
    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Canvas).call(this, props));
    _this.state = {
      isDraw: false
    };
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Canvas, [{
    ...
    value: function render() {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx("canvas", {
        ref: this.canvas,
  ...
  return Canvas;
}(react__WEBPACK_IMPORTED_MODULE_5___default.a.Component); // const Dynamsoft = window.Dynamsoft;
...
function (_React$Component4) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Scanner, _React$Component4);
  ...
  function Scanner(props) {
    ...
    _this2 = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Scanner).call(this, props));
    _this2.state = {
      resultsInfo: [],
      isOpen: false,
      resultsPoint: [],
      camera: 0,
      cameraList: [],
      isFullRegion: _this2.props.isFullRegion,
      resolution: _SettingPage__WEBPACK_IMPORTED_MODULE_10__["settingsFromPage"].resolution,
      barcodeFormat: _SettingPage__WEBPACK_IMPORTED_MODULE_10__["settingsFromPage"].barcodeformat,
      localization: _SettingPage__WEBPACK_IMPORTED_MODULE_10__["settingsFromPage"].localization,
      deblurLevel: _SettingPage__WEBPACK_IMPORTED_MODULE_10__["settingsFromPage"].deblurlevel,
      cameraOptions: null
    };
    return _this2;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Scanner, [{
    ...
    value: function showScanner() {
      ...
      var updateFrame = function updateFrame() {
        var regionScale = 1.0 * _this3.props.region / 100;
      ...
      Dynamsoft.BarcodeScanner.createInstance({
        ...
        if (scanner._isOpen === false) {
          console.log("open!");
          scanner.open().then(function (paras) {
            scanner.setResolution(_this3.state.resolution);
            var settings = scanner.getRuntimeSettings();
            settings.barcodeFormatIds = _this3.state.barcodeFormat;
            settings.localizationModes = _this3.state.localization;
            settings.deblurLevel = _this3.state.deblurLevel; // console.log(settings);
              ...
              scanner.getAllCameras().then(function (cameras) {
                _this3.setState({
                  ...
                  cameraOptions: cameras.map(function (cameraOption, index) {
                    return __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Select"].Option, {
                      value: "camera:" + index,
                ...
                scanner.setCurrentCamera(cameras[_this3.state.camera].deviceId);
              });
            });
          });
          /*.then((r)=>{
    ...
    value: function componentWillUnmount() {//this.showScanner();
    }
  }, {
    ...
    value: function onSwitchCamera(value) {
      ...
      scanner.getAllCameras().then(function (infos) {
        ...
        scanner.setCurrentCamera(infos[_this4.state.camera].deviceId);
        var config = {};
        config.content = "Switch to " + infos[_this4.state.camera].label + " successfully!";
        config.icon = __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Icon"], {
          type: "smile",
          style: {
            color: "#FE8E14"
    ...
    value: function render() {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx("style", {
        type: "text/css"
      }, "\n                .waiting{\n                    position:absolute;\n                    left:50%;\n                    top:50%;\n                    transform:translate(-50%);\n                    color:#FE8E14;\n                    transition: opacity 1000ms ease-in;\n                }\n\n                .fade-enter.fade-enter-active {\n                    opacity:1;\n                    transition: opacity 1000ms ease-in;\n                }\n\n                .fade-enter{\n                    opacity:0;\n                }\n\n                .fade-leave{\n                    opacity: 1; \n                }\n\n                .fade-leave.fade-leave-active{\n                    opacity:0;\n                    transition: opacity 3000ms ease-in;\n                }\n                \n                .fade-appear{\n                    opacity:0;\n                }\n\n                .fade-appear.fade-appear-active {\n                    opacity: 1;\n                    transition: opacity 2000ms ease-in;\n                }\n                "), __jsx(react_addons_css_transition_group__WEBPACK_IMPORTED_MODULE_8___default.a, {
        transitionName: "fade",
      ...
      }, !this.state.isOpen && __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Spin"], {
        className: "waiting",
        tip: "Accessing Camera list...",
        indicator: __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Icon"], {
          type: "smile",
          spin: true,
          style: {
            fontSize: "3rem"
        ...
        playsInline: true
      }), __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, allCanvas))), __jsx(Result, {
        resultsInfo: this.state.resultsInfo
      }), this.state.cameraList.length && __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Select"], {
        ...
        suffixIcon: __jsx(antd__WEBPACK_IMPORTED_MODULE_7__["Icon"], {
          type: "camera",
          style: {
            color: "#FE8E14"
          }
  ...
  return Scanner;
}(react__WEBPACK_IMPORTED_MODULE_5___default.a.Component); //export default connect(mapStateToProps,mapDispatchsToProps)(Scanner);
...
//# sourceMappingURL=index.js.e25b0230b9098afd867d.hot-update.js.map