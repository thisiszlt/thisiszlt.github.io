...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(FilePage, [{
    ...
    value: function componentWillUnmount() {// reader.destroy();
    }
  }, {
    key: "decodeFile",
    value: function decodeFile(file) {
      ...
      Dynamsoft.BarcodeReader.createInstance().then(function (r) {
        ...
        settings.barcodeFormat = _this2.state.barcodeFormat;
        settings.settings.localizationModes = _this2.state.localization;
        settings.deblurLevel = _this2.state.deblurLevel;
    ...
    value: function render() {
      ...
      }) : uploadButton))), this.state.resultsInfo.length && __jsx("div", null, __jsx(antd__WEBPACK_IMPORTED_MODULE_9__["List"] // header={<div>Scanning Result</div>}
      , {
...
//# sourceMappingURL=index.js.a4c018371061b95aa781.hot-update.js.map