      ...
      Dynamsoft.BarcodeScanner.createInstance({
        ...
        if (scanner._isOpen === false) {
          ...
          scanner.show().then(function (paras) {
            scanner.setResolution(_this4.state.resolution); // scanner.updateVideoSettings({ video: {facingMode: "environment" } });
...
//# sourceMappingURL=index.js.429696522ae743e4d0db.hot-update.js.map